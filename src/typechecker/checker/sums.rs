...
/// match of `parameter_name`, or a name that is a DIRECT copy of it (`renamed = result`,
/// chased transitively), anywhere in `body` — [`TypeChecker::reject_if_bound_and_unresolved`]'s
