...
| Dead top-level functions: a non-exported function nothing calls — or, outside `quilon test`, a function only a `describe`/`it` block reaches — is a compile error naming it | ✅ |
