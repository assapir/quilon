...
contract. A [failed or unrepresentable allocation](../memory.md) has no expression to
point at and prints its message on its own. Reports are colored when stderr is a terminal, and plain when redirected or under
