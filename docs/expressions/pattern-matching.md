...
- a **`Text`** scrutinee may also be matched against literal text arms (`"hi"`), alongside its catch-all. A pattern is a plain literal ([QN116](../tooling/errors/syntax.md#qn116--text-pattern-with-interpolation)); to match against a computed text, bind the value and compare it in the arm.
...
See [QN114](../tooling/errors/syntax.md#qn114--match-used-as-a-match-arm-body-without-parentheses).
