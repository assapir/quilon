...
pub use test_registry::{
    __test_case_failing, __test_case_finish, __test_case_run, __test_case_selected, __test_depth,
    __test_failed, __test_passed, __test_suite_enter, __test_suite_leave, __test_suite_selected,
    __test_summary,
};
pub use text::{
...
intrinsic_registry! {
    ...
    __test_case_run: extern "C" fn(*const c_void, *mut c_void),
}
